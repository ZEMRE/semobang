	...
	<body>
		...
		<form action="registerUser" method="post">
			<table>
				...
				<tr>
					<td>
						<input type="radio" name="user_level" id="customer" value="customer"><label for="customer">사용자</label>
						<input type="radio" name="user_level" id="pending" value="pending"><label for="pending">등록자</label>
					</td>	
				</tr>
				<tr align="center">
					<td colspan="2">
	 ...
	 /* 
		...
		$("#user_email").blur(function() {
			...
			$.ajax({
				url : './duplicateCheck?user_Email='+ user_email,
				type : 'get',
