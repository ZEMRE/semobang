	                  ...
	                  <div class="col-md-12"> 
                        <div class="pull-right">
                            <div class="pagination">
                                ...
                                <ul>
                                <c:if test="${pageMaker.prev}"><li><a href='./recommendList?page=${pageMaker.startPage-1}'>이전</a></li></c:if>
                                <c:forEach var="num" begin="${pageMaker.startPage }" end="${pageMaker.endPage }">
                                  	 <li><a href="./recommendList?page=${num}" id="<c:out value="${cri.page == num? 'active-pagination' : '' }"/>">${num}</a></li>
                                    </c:forEach>
                                <c:if test="${pageMaker.next }"><li><a href='./recommendList?page=${pageMaker.endPage +1}'>다음</a></li></c:if> 
                                    <!-- <li><a href="#">1</a></li>
                                    <li><a href="#">2</a></li>
                                    <li><a href="#">3</a></li>
                                    <li><a href="#">4</a></li>
