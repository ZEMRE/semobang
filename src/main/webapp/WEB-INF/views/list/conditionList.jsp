                        ...
                        <c:forEach var="conditionList" items="${conditionList}">
                            ...
                            <div class="col-sm-6 col-md-4 p0">
                                    ...
                                    <div class="box-two proerty-item">
                                        ...
                                        <form name="searchfr" id="searchfr" action="/semobang/${conditionList.property_id}" method="post">
                                        ...
                                        <div class="item-entry overflow">
                                            <h5><a href="#"> ${conditionList.property_title } </a></h5>
                                            <div class="dot-hr"></div>
                                            <span class="pull-left"><b> 매물번호 :</b> ${conditionList.property_id} </span>
                                            <span class="proerty-price pull-right"> $ 300,000</span>
                                            <p style="display: none;">Suspendisse ultricies Suspendisse ultricies Nulla quis dapibus nisl. Suspendisse ultricies commodo arcu nec pretium ...</p>

                                            <div class="property-icon" id="property-icon">
                                            <c:set var="propertyOOO" value="${conditionList.property_option}" />
                        ...
                        <div class="pull-right">
                            <div class="pagination">
                                ...
                                <c:forEach var="num" begin="${pageMaker.startPage }" end="${pageMaker.endPage }">
                                  	 <li><a href="./conditionList?page=${num}" id="<c:out value="${cri.page == num? 'active-pagination' : '' }"/>">${num}</a></li>
                                    </c:forEach>
