                        ...
                        <c:forEach var="popularList" items="${popularList}">
                            ...
                            <div class="col-sm-6 col-md-4 p0">
                                    ...
                                    <div class="box-two proerty-item">
                                        ...
                                        <form name="searchfr" id="searchfr" action="/semobang/${popularList.property_id}" method="post">
                                        ...
                                        <div class="item-entry overflow">
                                            <h5><a href="#"> ${popularList.property_title } </a></h5>
                                            <div class="dot-hr"></div>
                                            <span class="pull-left"><b> 매물번호 :</b> ${popularList.property_id} </span>
                                            <span class="proerty-price pull-right"> $ 300,000</span>
                                            <p style="display: none;">Suspendisse ultricies Suspendisse ultricies Nulla quis dapibus nisl. Suspendisse ultricies commodo arcu nec pretium ...</p>
                                            <div class="property-icon">
                                                <c:set var="propertyOption" value="${popularList.property_option}" />
	                  ...
	                  <div class="col-md-12"> 
                        <div class="pull-right">
                            <div class="pagination">
                                ...
                                <ul>
                                <c:if test="${pageMaker.prev}"><li><a href='./popularList?page=${pageMaker.startPage-1}'>이전</a></li></c:if>
                                <c:forEach var="num" begin="${pageMaker.startPage }" end="${pageMaker.endPage }">
                                  	 <li><a href="./popularList?page=${num}" id="<c:out value="${cri.page == num? 'active-pagination' : '' }"/>">${num}</a></li>
                                    </c:forEach>
                                <c:if test="${pageMaker.next }"><li><a href='./popularList?page=${pageMaker.endPage +1}'>다음</a></li></c:if> 
                                    <!-- <li><a href="#">1</a></li>
                                    <li><a href="#">2</a></li>
                                    <li><a href="#">3</a></li>
                                    <li><a href="#">4</a></li>
